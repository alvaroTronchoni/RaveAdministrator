 ...
 */
public class FragmentFestivalFotos extends Fragment {
    ...
    public static FragmentFestivalFotos newInstance(String param1, String param2) {
        FragmentFestivalFotos fragment = new FragmentFestivalFotos();
    ...
    public class FetchFestivalDataTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                urlConnection.setRequestProperty("Authorization", "cebd8edc784ee938c7c75c8c838d6deb");
        ...
        private String getFestivalDataFromJson(String festivalDataJsonStr) throws JSONException {
            ...
            return infoObject.getString("instagramUserFestival");
        }
